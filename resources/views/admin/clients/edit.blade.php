                ...
                <div class="col-md-12">
                    ...
                    <div class="container">
                        ...
                        <div class="form-group">
                            {!! Form::label('Criado por:', 'Criado Por:') !!}{{ $client->atendente }}<br><br>
                            {!! Form::label('Atualizado por:', 'Atualizado por:') !!} {{ $client->atendente }}
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <a href=" {{route('admin.clients.index')}}" class="btn btn-primary"> Cancelar </a> <br><br>
                        </div>
